...
def test_10x(func, name, rand, r, n):
    print(f"Benchmark for {name} \n@ {n} datas ranging from 1 - {r} -- {rand} datas")
    for i in range(1,11):
...
def test_10x_n_sorted(func, name, rand, r, n):
    print(f"Benchmark for {name} \n@ {n} sorted datas ranging from 1 - {r} -- {rand} datas")
    for i in range(1,11):
        arr1 = random.choices(range(1, r), k = n)
...
def test_10x_sorted(func, name, rand, r, n):
    print(f"Benchmark for {name} \n@ {n} sorted datas ranging from 1 - {r} -- {rand} datas")
    for i in range(1,11):
        arr1 = random.choices(range(1, r), k = n)
        arr1.sort()
...
def test_10x_r_sorted(func, name, rand, r, n):
    print(f"Benchmark for {name} \n@ {n} sorted datas ranging from 1 - {r} -- {rand} datas")
    for i in range(1,11):
        arr1 = random.choices(range(1, r), k = n)
        arr1.sort()
