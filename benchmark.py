...
t1 = timeit(
    "selectionSort(arr1)",
    setup="from normal_algo.normal_selection import selectionSort",
    number = 10,
    globals={"arr1":arr1},
)
...
t2 = timeit(
    ...
    setup="from enhanced_algo.pointer_selection import enhanced_selection",
    number = 10,
...
t3 = timeit(
    ...
    setup="from enhanced_algo.pointer_selection_merge import enhanced_selection_merge",
    number = 10,
...
t8 = timeit(
    ...
    setup="from enhanced_algo.jesreal_sort import fastbit_radix_like_sort",
    number = 10,
...
t9 = timeit(
    ...
    setup="from normal_algo.bubble_sort import bubbleSort",
    number = 10,
...
t9 = timeit(
    ...
    setup="from normal_algo.radix_sort import radixSort",
    number = 10,
...
t10 = timeit(
    ...
    setup="from normal_algo.normal_fastbit_radix import fastbit_radix_sort",
    number = 10,
